...
{
    mChildItems.push_back(std::unique_ptr<ProtoTreeItem>(new ProtoTreeItem(field, this)));
...
void ProtoTreeItem::setValue(const QString &data)
{
    mValue = data;
}
...
QString ProtoTreeItem::value() const
{
    return mValue;
}
...
QColor ProtoTreeItem::color() const
{
